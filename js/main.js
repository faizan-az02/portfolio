...
const CONFIG = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: 'Built a content-based image retrieval system using Locality-Sensitive Hashing (LSH). Extracted image feature histograms and implemented an interactive web interface for approximate nearest neighbor search.',
